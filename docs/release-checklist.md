...
- ✍️ App Review 連絡先情報(氏名/電話/メール、要本人入力) / 🌐 CI 用 GitHub Secrets (Mac ローカル運用なら不要)
...
- [x] version 1.0 に **ビルド 1.0(1) を添付**、App Review「サインインが必要です」を**オフ**(ログイン不要アプリのため)(2026-07-30)
- [ ] ⛔ **App Review 連絡先情報**(姓/名/電話番号/メール)を入力 — 提出必須・**個人情報のため本人入力**
- [ ] 🚦 **審査に提出**(「審査用に追加」→「審査に提出」)— 上記連絡先入力後の最終アクション
